...
void sub_08043420(void)
{
    ...
    case 0:
        ...
        if (main->unk0386 != 0x0A)
            BtlEntitySelectByKeyDefault((struct Unk680CC *)&main->unk036C, 0x0A);
        break;
    case 1:
        main = gMainWorkPtr;
        if ((main->unk0374 >> 8) >= gUnk_03000554->unk06)
        ...
        if (main->unk0386 != 0x0B)
            BtlEntitySelectByKeyDefault((struct Unk680CC *)&main->unk036C, 0x0B);
        break;
    case 2:
        main = gMainWorkPtr;
        ...
        main->unk1810 = 0x20;
        if (main->unk0386 != 8)
            BtlEntitySelectByKeyDefault((struct Unk680CC *)&main->unk036C, 8);
        break;
    case 3:
        main = gMainWorkPtr;
        if ((main->unk0370 >> 8) <= gUnk_03000554->unk04)
