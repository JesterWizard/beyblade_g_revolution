...
_Updated: 2026-09-24T18:14:21Z_
...
|----------|--------|--:|------:|------|
| `sub_08040F4C` | WIP (parked C) | 94.9% | 319/336 | 319/336 agbcc; prologue fork: 225/336 gets r5 but wrong 6639C order |
...
| `sub_08067F3C` | WIP (parked C) | 63.0% | 58/92 | 58/92 size mismatch (96 vs 92); product in r3 not r2, u16 countdown is lsls/lsrs |
| `sub_08032908` | WIP (parked C) | 61.2% | 235/384 | three attempts: 151/384 (388B), 235/384 (388B) retained; loc-pin rewrite 114/… |
| `sub_08067FC8` | WIP (parked C) | 58.1% | 43/74 | 43/74 same-size; total=0 must precede the call, entry check uses r8 |
...
| `sub_080699C8` | WIP (parked C) | 31.2% | 25/80 | size mismatch; shared tail not reproducible |
...
| `sub_08073114` | WIP (parked C) | 16.1% | 18/112 | 18/112 (108B); i=0 must precede count=...; table pseudo wants r1 not r0 |
...
| `sub_08044FB0` | size DIFF | 11.0% | 19/156 |  |
| `sub_080419B0` | size DIFF | 11.0% | 19/172 |  |
...
| `sub_08073AEC` | size DIFF | 8.3% | 17/162 |  |
...
| `sub_08067F3C` | `0x08067F3C` | WIP (parked C) | 63.0% | 58/92 | asm |
| `sub_08032908` | `0x08032908` | WIP (parked C) | 61.2% | 235/384 | asm |
| `sub_08067FC8` | `0x08067FC8` | WIP (parked C) | 58.1% | 43/74 | asm |
...
| `sub_080699C8` | `0x080699C8` | WIP (parked C) | 31.2% | 25/80 | asm |
...
| `sub_08073114` | `0x08073114` | WIP (parked C) | 16.1% | 18/112 | asm |
...
| `sub_08044FB0` | `0x08044FB0` | size DIFF | 11.0% | 19/156 | asm |
| `sub_080419B0` | `0x080419B0` | size DIFF | 11.0% | 19/172 | asm |
...
| `sub_08062728` | `0x08062728` | matched | 100.0% | 18/18 | semantic |
...
| `sub_08033F30` | `0x08033F30` | matched | 100.0% | 24/24 | semantic |
...
| `sub_08069F00` | `0x08069F00` | matched | 100.0% | 24/24 | semantic |
...
| `sub_08035908` | `0x08035908` | matched | 100.0% | 36/36 | semantic |
...
| `sub_0806BE20` | `0x0806BE20` | matched | 100.0% | 36/36 | semantic |
...
| `sub_080428C4` | `0x080428C4` | matched | 100.0% | 44/44 | semantic |
...
| `sub_08062D50` | `0x08062D50` | matched | 100.0% | 46/46 | semantic |
| `sub_0806D748` | `0x0806D748` | matched | 100.0% | 46/46 | semantic |
...
| `sub_08062068` | `0x08062068` | matched | 100.0% | 48/48 | semantic |
| `sub_080628B4` | `0x080628B4` | matched | 100.0% | 48/48 | semantic |
| `sub_08062CF4` | `0x08062CF4` | matched | 100.0% | 48/48 | semantic |
...
| `sub_080320CC` | `0x080320CC` | matched | 100.0% | 52/52 | semantic |
| `sub_08035020` | `0x08035020` | matched | 100.0% | 52/52 | semantic |
...
| `sub_08043B58` | `0x08043B58` | matched | 100.0% | 54/54 | semantic |
...
| `sub_0804495C` | `0x0804495C` | matched | 100.0% | 60/60 | semantic |
| `sub_080603A4` | `0x080603A4` | matched | 100.0% | 60/60 | semantic |
| `sub_08060468` | `0x08060468` | matched | 100.0% | 60/60 | semantic |
| `sub_080617C4` | `0x080617C4` | matched | 100.0% | 60/60 | semantic |
...
| `sub_08071F44` | `0x08071F44` | matched | 100.0% | 64/64 | semantic |
...
| `sub_0806C78C` | `0x0806C78C` | matched | 100.0% | 70/70 | semantic |
...
| `sub_08062B9C` | `0x08062B9C` | matched | 100.0% | 76/76 | semantic |
...
| `sub_08052934` | `0x08052934` | matched | 100.0% | 84/84 | semantic |
...
| `sub_0805264C` | `0x0805264C` | matched | 100.0% | 96/96 | semantic |
| `sub_08061BE8` | `0x08061BE8` | matched | 100.0% | 96/96 | semantic |
| `sub_08069894` | `0x08069894` | matched | 100.0% | 96/96 | semantic |
| `sub_08071E84` | `0x08071E84` | matched | 100.0% | 96/96 | semantic |
| `sub_08071EE4` | `0x08071EE4` | matched | 100.0% | 96/96 | semantic |
...
| `sub_080610A8` | `0x080610A8` | matched | 100.0% | 98/98 | semantic |
...
| `sub_08061D00` | `0x08061D00` | matched | 100.0% | 104/104 | semantic |
