...
| **Decompiled C (functions)** | **127/633 (20.1%)** |
| **Decompiled C (bytes)** | **3,594/90,272 (4.0%)** |
| Not opcode (C + readable Thumb) | 277/633 (43.8% fn, 45.4% bytes) |
| Readable Thumb | 150/633 (23.7%) |
| Opcode `.byte` embeds | 356/633 (56.2%) |
