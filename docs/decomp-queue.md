...
_Updated: 2026-09-20T08:34:20Z_
...
|--------|------:|
| Semantic C done | 262 |
| Still need semantic C | **371** |
| Readable Thumb remaining | 371 |
...
Full ranked backlog (340 functions): [`decomp-queue.json`](decomp-queue.json)
