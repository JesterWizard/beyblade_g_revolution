...
_Updated: 2026-09-20T08:33:42Z_
...
|--------|------:|
| Semantic C done | 261 |
| Still need semantic C | **372** |
| Readable Thumb remaining | 372 |
...
Full ranked backlog (341 functions): [`decomp-queue.json`](decomp-queue.json)
