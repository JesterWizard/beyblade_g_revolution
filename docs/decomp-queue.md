...
_Updated: 2026-09-19T22:24:12Z_
...
|--------|------:|
| Semantic C done | 242 |
| Still need semantic C | **391** |
| Readable Thumb remaining | 391 |
...
Full ranked backlog (358 functions): [`decomp-queue.json`](decomp-queue.json)
