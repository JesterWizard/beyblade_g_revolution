...
_Updated: 2026-09-19T23:46:47Z_
...
|--------|------:|
| Semantic C done | 253 |
| Still need semantic C | **380** |
| Readable Thumb remaining | 380 |
...
Full ranked backlog (349 functions): [`decomp-queue.json`](decomp-queue.json)
