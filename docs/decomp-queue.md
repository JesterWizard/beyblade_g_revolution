...
_Updated: 2026-09-19T22:17:44Z_
...
|--------|------:|
| Semantic C done | 241 |
| Still need semantic C | **392** |
| Readable Thumb remaining | 392 |
...
Full ranked backlog (359 functions): [`decomp-queue.json`](decomp-queue.json)
