...
_Updated: 2026-09-20T08:32:22Z_
...
|--------|------:|
| Semantic C done | 260 |
| Still need semantic C | **373** |
| Readable Thumb remaining | 373 |
...
Full ranked backlog (342 functions): [`decomp-queue.json`](decomp-queue.json)
