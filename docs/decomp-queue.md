...
_Updated: 2026-09-19T11:44:05Z_
...
|--------|------:|
| Semantic C done | 223 |
| Still need semantic C | **410** |
| Readable Thumb remaining | 410 |
...
Full ranked backlog (375 functions): [`decomp-queue.json`](decomp-queue.json)
