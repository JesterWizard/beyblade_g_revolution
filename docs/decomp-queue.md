...
_Updated: 2026-09-19T16:55:16Z_
...
|--------|------:|
| Semantic C done | 233 |
| Still need semantic C | **400** |
| Readable Thumb remaining | 400 |
...
Full ranked backlog (365 functions): [`decomp-queue.json`](decomp-queue.json)
