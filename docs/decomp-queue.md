...
_Updated: 2026-09-18T22:35:19Z_
...
|--------|------:|
| Semantic C done | 207 |
| Still need semantic C | **426** |
| Readable Thumb remaining | 426 |
...
Full ranked backlog (403 functions): [`decomp-queue.json`](decomp-queue.json)
