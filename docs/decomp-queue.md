...
_Updated: 2026-09-19T12:24:52Z_
...
|--------|------:|
| Semantic C done | 226 |
| Still need semantic C | **407** |
| Readable Thumb remaining | 407 |
...
Full ranked backlog (372 functions): [`decomp-queue.json`](decomp-queue.json)
