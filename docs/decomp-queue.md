...
_Updated: 2026-09-19T11:54:46Z_
...
|--------|------:|
| Semantic C done | 224 |
| Still need semantic C | **409** |
| Readable Thumb remaining | 409 |
...
Full ranked backlog (374 functions): [`decomp-queue.json`](decomp-queue.json)
