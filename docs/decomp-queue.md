...
_Updated: 2026-09-19T23:31:16Z_
...
|--------|------:|
| Semantic C done | 248 |
| Still need semantic C | **385** |
| Readable Thumb remaining | 385 |
...
Full ranked backlog (354 functions): [`decomp-queue.json`](decomp-queue.json)
