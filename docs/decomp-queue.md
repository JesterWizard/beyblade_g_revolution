...
_Updated: 2026-09-18T22:21:20Z_
...
|--------|------:|
| Semantic C done | 202 |
| Still need semantic C | **431** |
| Readable Thumb remaining | 431 |
...
Full ranked backlog (410 functions): [`decomp-queue.json`](decomp-queue.json)
