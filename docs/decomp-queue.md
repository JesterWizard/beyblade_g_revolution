...
_Updated: 2026-09-19T08:04:42Z_
...
|--------|------:|
| Semantic C done | 221 |
| Still need semantic C | **412** |
| Readable Thumb remaining | 412 |
...
Full ranked backlog (377 functions): [`decomp-queue.json`](decomp-queue.json)
